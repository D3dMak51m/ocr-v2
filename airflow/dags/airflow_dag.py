...
def call_fastapi_inference(**context):
    ...
    fastapi_url = os.getenv('FASTAPI_URL', 'http://backend:8282')
    ...
    ocr_request = {
        "url": dag_run_conf.get('url', "https://cf2.ppt-online.org/files2/slide/s/sEJXuRQk0xK4tH3ilIL1AMTB87dOmwcybo6aFSfpN/slide-0.jpg"),
...
dag = DAG('airflow_dag', default_args=default_args, schedule_interval=None, catchup=False, is_paused_upon_creation=False)
